...
class MatrizWS2812B:
    def __init__(self, pin, num_pixeles, ancho, alto, brillo=1.0):
        """
        ...
        self.alto = alto
        self.brillo = brillo
        self.np = neopixel.NeoPixel(machine.Pin(pin), num_pixeles)
        self.apagar_matriz()
...
# Ejemplo de uso
pin_datos = 4  # Ajusta al pin correcto
ancho_matriz = 8
alto_matriz = 8
num_pixeles = ancho_matriz * alto_matriz
matriz = MatrizWS2812B(pin_datos, num_pixeles, ancho_matriz, alto_matriz, brillo=0.5)
